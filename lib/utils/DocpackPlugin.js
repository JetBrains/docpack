...
var PluginError = require('./DocpackPluginError');
var PluginWarning = require('./DocpackPluginWarning');
...
function createPlugin(opts) {
  ...
  PluginImplementation.prototype.emitError = function(message) {
    return new PluginError(message, this);
  };

  PluginImplementation.prototype.emitWarning = function(message) {
    return new PluginWarning(message, this);
  };
