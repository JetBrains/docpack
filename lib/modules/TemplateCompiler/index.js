...
function TemplateCompiler(compilation, templatePath) {
  ...
  compiler.apply(
    ...
    new LibraryTemplatePlugin('DOCPACK_RESULT', 'var'),
...
TemplateCompiler.prototype.evaluateCompilationResult = function (source) {
  ...
  source = source.replace('var DOCPACK_RESULT =', '');

  var templatePath = this.templatePath;
  var vmContext = vm.createContext(extend(true, {DOCPACK: true, require: require}, global));
