...
var addEntry = require('webpack-toolkit/lib/addEntry');
...
function DocsPlugin(config) {
  if (this instanceof DocsPlugin == false) {
...
DocsPlugin.prototype.readFile = function(filepath) {
  return readFile(this.compiler.inputFileSystem, filepath);
};
